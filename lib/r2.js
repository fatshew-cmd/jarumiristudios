...
const { S3Client, PutObjectCommand, GetObjectCommand, DeleteObjectCommand, DeleteObjectsCommand, HeadObjectCommand, ListObjectsV2Command } = require("@aws-sdk/client-s3");
...
module.exports = { r2Client, BUCKET, putObject, streamUpload, getPresignedDownloadUrl, deleteObject, deleteObjects, deleteObjectsByPrefix, deleteObjectsByPrefixExcept, headObject, listObjectKeys };
